...
import com.framework.security.handler.JwtAuthenticationEntryPoint;
import com.framework.security.handler.JwtAuthorizationFilter;
import com.framework.security.handler.MyLogoutSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                .authorizeRequests()
                // 测试用资源，需要验证了的用户才能访问
                .antMatchers("/teamwork/login", "/captcha", "/favicon.ico").permitAll()
